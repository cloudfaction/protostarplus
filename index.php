...
$doc->addStyleSheet($this->baseurl . '/templates/' . $this->template . '/css/template960.css');
}
...
.ftr{background-color: <?php echo $this->params->get('templateFooterBgColor'); ?> !Important; padding: 10px; min-height:<?php echo $this->params->get('footerheight'); ?>px;}
...
@media (max-width: 480px) {.ftr{min-height:<?php echo $this->params->get('footerheight')*3.7; ?>px;}}
